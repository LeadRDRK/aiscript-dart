///
/// File: example/attributes_alt.dart
...
/// 
/// For a more common way to access attributes, see `example/attributes.dart`.
///
...
''');
  ...
  // For this example, we'll use the root scope directly
  await state.exec(nodes, Context(state.scope));
